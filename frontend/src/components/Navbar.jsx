              ...
              <>
                ...
                {isAuth() ? (
                  ...
                  <>
                    ...
                    <button 
                    // className="lg:block hidden text-center transform ease-in duration-100 hover:-translate-y-1 p-3 hover:shadow-lg w-[100px] justify-center px-8 p-1  bg-[#F2994A] text-white rounded-full text-lg font-semibold"
                      >
                    <Link
                      className="lg:block hidden text-center transform ease-in duration-100 hover:-translate-y-1 hover:shadow-lg w-[100px] justify-center px-4 p-1  bg-[#F2994A] text-white rounded-full text-lg font-semibold"
                      to="/sign-up"
                    >    Sign up
